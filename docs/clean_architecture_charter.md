<!-- docs/clean_architecture_charter.md -->
<!--
Clean Architecture Charter for Ash Service
FILE VERSION: v3.1-1
LAST MODIFIED: 2025-08-29
CLEAN ARCHITECTURE: v3.1
-->
# Clean Architecture Charter - Ash
...
- **Version increments**: Required for each change within a step
...
- **Version Headers should include at the top of the header a file description of what the file code does**
  - `[fileDescription] for Ash Service`

#### **Required Version Header Format:**
```python
"""
Ash: Crisis Detection for The Alphabet Cartel Discord Community
********************************************************************************
{fileDescription} for Ash Service
---
...
${ASH_CRISIS_AMPLIFIER_BASE_WEIGHT}     # New variable
${ASH_POSITIVE_REDUCER_BASE_WEIGHT}     # New variable

# ✅ RIGHT: Reusing existing variables with conversion
ASH_ANALYSIS_CONTEXT_BOOST_WEIGHT=1.5   # Existing variable
# Convert: crisis_base_weight = context_boost_weight * 0.1 = 0.15

ASH_CONFIG_CRISIS_CONTEXT_BOOST_MULTIPLIER=1.0  # Existing variable  
...
### **Rule #8: Always use real-world tests and python's logger function and methods for testing - MANDATORY**
...
```python
"""
Ash: Crisis Detection Backend for The Alphabet Cartel Discord Community
********************************************************************************
{managerDescription} for Ash Service
---
...
```json
{
  ...
  "crisis_thresholds": {
    ...
    "high": "${ASH_ANALYSIS_CRISIS_THRESHOLD_HIGH}",
    "medium": "${ASH_ANALYSIS_CRISIS_THRESHOLD_MEDIUM}",
    "low": "${ASH_ANALYSIS_CRISIS_THRESHOLD_LOW}",
    "defaults": {
      "high": 0.55,
      "medium": 0.28,
      "low": 0.16
